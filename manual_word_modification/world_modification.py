...
║ {json_path}. 
║ Tam też zostanie zapisany końcowy plik JSON i odpowiadający mu PNG.
║ Pliki pomocnicze (wizualizacje każdej zmiany) znajdują się tamże w podkatalogu: 
║ {world_name}_{date_folder}.
║ 
