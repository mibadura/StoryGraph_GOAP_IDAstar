...
for mission in jsons_sg_validated:
    for production in mission["json"]:
        ...
        if production.get('Instructions'):  # Nie świat
            ...
            image_save_dir = f'{json_path}/aktualne wizualizacje/{mission["file_path"].rsplit(os.sep, 1)[0].split(".json", 1)[0]}/'
            ...
            d_w = True
            draw_id = False
            d_dir = f'{json_path}/aktualne wizualizacje/{mission["file_path"].rsplit(os.sep, 1)[0]}/'
