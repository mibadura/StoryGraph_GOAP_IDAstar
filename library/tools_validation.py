...
from library.tools import get_json_files_paths, print_lines, nodes_list_from_tree, breadcrumb_pointer, \
    attributes_from_nodes_list, find_node_layer_name, paths_convert_to_text, get_project_root
...
def get_allowed_names() -> dict:
    ...
    # allowed_items = json.load(open('../json_validation/allowed_names/items.json', encoding="utf8"))
    # allowed_items += json.load(open('../json_validation/allowed_names/items_Wojtek.json', encoding="utf8"))
    allowed_locations = json.load((get_project_root() / Path('json_validation/allowed_names/locations.json')).open(encoding="utf8"))
    allowed_locations += json.load((get_project_root() / Path('json_validation/allowed_names/locations_Wojtek.json')).open(encoding="utf8"))

    allowed_characters = json.load((get_project_root() / Path('json_validation/allowed_names/characters.json')).open(encoding="utf8"))
    allowed_characters += json.load((get_project_root() / Path('json_validation/allowed_names/characters_Wojtek.json')).open(encoding="utf8"))

    allowed_items = json.load((get_project_root() / Path('json_validation/allowed_names/items.json')).open(encoding="utf8"))
    allowed_items += json.load((get_project_root() / Path('json_validation/allowed_names/items_Wojtek.json')).open(encoding="utf8"))
